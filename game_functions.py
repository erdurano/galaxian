...
def fire_bullet(ai_settings, screen, ship, bullets):
    # Create a bullet to the bullets group
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    # update position of bullets and get rid of the bullets.
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0:
        # Destroy existing bullets and repopulate fleet, speedup, level up.
        bullets.empty()
...
def check_fleet_edges(ai_settings, aliens):
    # Respond if any of the aliens reach the edge.
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    # Check if ay alien touch the bottom
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    for row_number in range(number_rows):
        for alien_number in range(number_aliens_x):
            # Create an alien an place it on the row
